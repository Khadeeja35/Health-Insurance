...
for values in ["age","bmi","children","charges"]:
    print(df[values].mean())
    print(df[values].median())
    print(df[values].mode())
    print(df[values].std())
    print(df[values].var())
    print(df[values].skew())
    print(df[values].kurt())
...
for values in ["sex","smoker","region"]:
    print(df[values].value_counts())
    print(df[values].value_counts(normalize=True))
    print(df[values].mode())
...
sns.relplot(data = df, x = "age", y = "charges", kind = "scatter", col = "smoker", hue = "children", height = 5, aspect = 1.5)
